...
<div class="banner">
    <div class="campaign-logo">
        <img src="https://galileo.farmerconnect.in/static/media/spinImage_gj.78868bed664de6ed9ef7.png" alt="Scan & Win">
    </div>
    <div class="status-card">
        <div class="status-title">અભિનંદન !!!</div>
        <div class="status-message">
            <strong>GALILEO (400ML)</strong> નો સીરિયલ નંબર સ્કેન
            પહેલેથી જ સ્કેન થઈ ચૂક્યો છે.
        </div>
    </div>
    <div class="actions">
        <div class="action-box">
            ...
            <a href="#" class="action-btn">રકમ જુઓ</a>
        </div>
        <div class="action-box">
            ...
            <a href="#" class="action-btn">વધુ સ્કેન કરો</a>
        </div>
    </div>
</div>
@endsection
